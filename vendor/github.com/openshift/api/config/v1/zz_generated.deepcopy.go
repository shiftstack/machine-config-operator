...
func (in *APILoadBalancer) DeepCopyInto(out *APILoadBalancer) {
	*out = *in
	if in.BGP != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new APILoadBalancer.
func (in *APILoadBalancer) DeepCopy() *APILoadBalancer {
	if in == nil {
		return nil
	}
	out := new(APILoadBalancer)
	in.DeepCopyInto(out)
	return out
}
